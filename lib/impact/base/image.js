...
.defines(() => {
    ...
    ig.Image = ig.Loadable.extend({
        ...
        draw(targetX, targetY, sourceX, sourceY, width = this.width, height = this.height, flipX, flipY, fragment, fragmentAlpha = 0, filtered = null) {
            // width = width !== undefined ? width : this.width;
            // height = height !== undefined ? height : this.height;
            // fragmentAlpha = fragmentAlpha || 0;
