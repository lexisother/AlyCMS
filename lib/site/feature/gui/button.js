    ...
    .defines(() => {
        ...
        ig.ButtonGui = ig.GuiElementBase.extend({
            ...
            transition: {
                ...
                "HIDDEN": { state: { alpha: 0, scaleX: 0, scaleY: 0 }, time: 0.3, timeFunction: KEY_SPLINES.EASE_IN }
            },

            textChild: null,

            init(text, width, active, keepPressed) {
                this.parent(active, keepPressed)
