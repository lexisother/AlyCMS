ig.module('site.site')
  .requires('impact.base.impact', 'impact.base.event', 'impact.feature.gui.base.basic-gui', 'site.feature.gui.button')
  .defines(() => {
    ig.Site = ig.Class.extend({
      ...
      init() {
        ...
        this.textGui = new ig.TextGui("Hello!\nTest one two three test!\nwoaaaah \\i[lb]test\\i[rb]", { speed: 0.05 })
        ...
        this.buttonGui.setPos(30, 30)
        ig.gui.addGuiElement(this.buttonGui)
      },
